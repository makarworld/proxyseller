...
class ProxySeller:
    ...
    def authActive(self, id: int, active: Literal["Y", "N"]) -> list:
        """
    ...
    def balanceAdd(self, summ: float = 5, paymentId: int = 29) -> str:
        """
    ...
    def balancePaymentsList(self) -> list:
        """
    ...
    def orderCalc(self, data: dict) -> dict:
        """
        Calculate the order.
    ...
    def orderCalcResident(self, tarifId: int, coupon: str = "OXSYUO_885446"):
        """
    ...
    def orderMakeResident(self, tarifId: int, coupon: str = "OXSYUO_885446"):
        """
    ...
    def proxyCommentSet(self, ids: list, comment: str = None):
        """
    ...
    def residentListRename(self, id: int, title: str):
        """
    ...
    def residentListDelete(self, id: int):
        """
    ...
    def residentSubUserDelete(self, package_key: str):
        """
    ...
    def residentSubUserLists(self, package_key: str, list_id: int = None):
        """
        ...
        return self.request("GET", "residentsubuser/lists", params=params)

    def residentSubUserListAdd(
        self,
        title: str,
        whitelist: str,
        geo: dict,
    ...
    def residentSubUserListRename(self, id: int, title: str, package_key: str):
        """
    ...
    def residentSubUserListRotation(self, id: int, rotation: int, package_key: str):
        """
    ...
    def residentSubUserListDelete(self, id: int, package_key: str):
        """
    ...
    def residentSubUserListTools(self, package_key: str):
        """
